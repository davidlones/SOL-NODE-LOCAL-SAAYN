...
Subsequent configured builds and physical-device acceptance are recorded in [ENDPOINT_VALIDATION.md](ENDPOINT_VALIDATION.md). The initial no-endpoint build described above is historical.
